...
public final class GCYMMetaTileEntities {
    ...
    public static MetaTileEntityParallelHatch[] PARALLEL_HATCH = new MetaTileEntityParallelHatch[8];
    ...
    public static void init() {
        ...
        ALLOY_BLAST_SMELTER = registerMetaTileEntity(2001, new MetaTileEntityAlloyBlastSmelter(gcymId("alloy_blast_smelter")));
        LARGE_ARC_FURNACE = registerMetaTileEntity(2002, new MetaTileEntityLargeArcFurnace(gcymId("large_arc_furnace")));
        ...
        LARGE_ELECTROLYZER = registerMetaTileEntity(2013, new MetaTileEntityLargeElectrolyzer(gcymId("large_electrolyzer")));
        ...
        // Hatches
        PARALLEL_HATCH[0] = registerMetaTileEntity(2050, new MetaTileEntityParallelHatch(gcymId("parallel_hatch.ev"), EV));
        PARALLEL_HATCH[1] = registerMetaTileEntity(2051, new MetaTileEntityParallelHatch(gcymId("parallel_hatch.iv"), IV));
        PARALLEL_HATCH[2] = registerMetaTileEntity(2052, new MetaTileEntityParallelHatch(gcymId("parallel_hatch.luv"), LuV));
        PARALLEL_HATCH[3] = registerMetaTileEntity(2053, new MetaTileEntityParallelHatch(gcymId("parallel_hatch.zpm"), ZPM));
        PARALLEL_HATCH[4] = registerMetaTileEntity(2054, new MetaTileEntityParallelHatch(gcymId("parallel_hatch.uv"), UV));
        PARALLEL_HATCH[5] = registerMetaTileEntity(2055, new MetaTileEntityParallelHatch(gcymId("parallel_hatch.uhv"), UHV));
        PARALLEL_HATCH[6] = registerMetaTileEntity(2056, new MetaTileEntityParallelHatch(gcymId("parallel_hatch.uev"), UEV));
        PARALLEL_HATCH[7] = registerMetaTileEntity(2057, new MetaTileEntityParallelHatch(gcymId("parallel_hatch.uiv"), UIV));

        for (int i = 0; i < TIERED_HATCH.length; i++) {
            if (!GregTechAPI.isHighTier() && i > GTValues.UHV)
                break;

            TIERED_HATCH[i] = registerMetaTileEntity(2058 + i,
